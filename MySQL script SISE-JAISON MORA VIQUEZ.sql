CREATE
DATABASE sise /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
select *
from province as p
         left join canton as c on c.id_province = p.id_province;
select *
from canton as c
         left join proprovinciaprovinciaprovinciavincia as p on c.id_provincia = p.id_province;

select *
from province as p
         right join canton as c on c.id_province = p.id_province;
select *
from canton as c
         right join provincia as p on c.id_province = p.id_province;
