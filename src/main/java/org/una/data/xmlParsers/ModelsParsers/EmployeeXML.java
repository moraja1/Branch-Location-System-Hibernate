package org.una.data.xmlParsers.ModelsParsers;

import org.una.data.repository.Branch;
import org.una.data.repository.Employee;
import org.una.data.xmlParsers.XMLParser;
...
public final class EmployeeXML extends XMLParser<Employee> {
    private static final String path = "src\\main\\java\\org\\una\\data\\xmlFiles\\Employees.xml";
    public EmployeeXML() {
        file = path;
        TAG = "employee";
        ROOT_TAG = "Employees";
